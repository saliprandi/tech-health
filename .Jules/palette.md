...
## 2026-03-30 - Micro-UX y accesibilidad en enlaces 'Volver arriba' en el pie de página
**Learning:** En páginas de aterrizaje extensas, un enlace 'Volver arriba' en el pie de página (`Footer.astro`) que combina micro-animaciones direccionales de desplazamiento (`group-hover:-translate-y-0.5 group-focus-visible:-translate-y-0.5`), un atributo `aria-label` descriptivo y un anillo de enfoque de alto contraste sobre fondo oscuro (`focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:ring-offset-2 focus-visible:ring-offset-navy-dark`) facilita enormemente la re-navegación ágil y accesible para usuarios de teclado y lectores de pantalla.
**Action:** Incluir siempre un enlace 'Volver arriba' con semántica WAI-ARIA, íconos vectoriales direccionales y anillos de enfoque adaptados al contraste del contenedor.
