...
## 2026-03-30 - Enlace de retorno al inicio 'Volver arriba' en el pie de página
**Learning:** En páginas de aterrizaje extensas (landing pages), los usuarios de navegación por teclado y lectores de pantalla al llegar al pie de página (`Footer.astro`) carecen de un mecanismo directo para re-navegar hacia la sección principal sin presionar la tecla Tab repetidamente hacia atrás. Incorporar un enlace 'Volver arriba' hacia `#hero` con un ícono direccional elevado (`group-hover:-translate-y-0.5 group-focus-visible:-translate-y-0.5`), anillo de enfoque de alto contraste y `aria-label` descriptivo facilita la navegación y orientación espacial.
**Action:** Incluir siempre un enlace de retorno 'Volver arriba' accesible en el pie de página principal en sitios de página única.
