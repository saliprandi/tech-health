...
## 2026-03-30 - Micro-UX de spinner de carga e intercambio de íconos en botones de envío de formulario de contacto
**Learning:** En botones de envío de formularios de contacto que desencadenan solicitudes asíncronas secundarias (como envío a webhooks antes de redirigir), conmutar la visibilidad de un spinner animado (`animate-spin`) y ocultar temporariamente el ícono vector de destino (ej. WhatsApp) refuerza la percepción de procesamiento activo sin perder contexto de marca.
**Action:** Incluir un ícono de carga animado (`animate-spin`) oculto por defecto e conmutar su visibilidad en conjunto con el ícono del botón durante estados de envío y redirección.
