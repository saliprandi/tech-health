...
## 2026-03-30 - Botón 'Volver arriba' accesible en pie de página para re-navegación eficiente
**Learning:** En páginas extensas de destino, la ausencia de un control explícito de "Volver arriba" obliga a usuarios de teclado y tecnologías de asistencia a realizar decenas de pulsaciones de tecla Shift+Tab para regresar al menú superior. Incorporar un enlace `[href="#hero"]` con etiquetado WAI-ARIA explicativo (`aria-label="Volver al inicio de la página"`), anillo de enfoque de alto contraste (`focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:ring-offset-2 focus-visible:ring-offset-navy-dark`) y micro-animación direccional en hover/focus-visible (`group-hover:-translate-y-0.5 group-focus-visible:-translate-y-0.5`) mejora drásticamente la orientación espacial y la navegabilidad de la página.
**Action:** Equipar los pies de página de landing pages con enlaces accesibles de retorno al inicio con anillos de enfoque contrastados y micro-animaciones de elevación.
