...
## 2026-03-30 - Re-navegación accesible por teclado y micro-animación en botones 'Volver arriba' sobre fondos oscuros
**Learning:** Incluir un enlace accesible 'Volver arriba' en el pie de página (`Footer.astro`) que apunta al elemento inicial de la página (`#hero`) facilita enormemente la re-navegación para usuarios de teclado y lectores de pantalla. Sobre fondos oscuros (`bg-navy-dark`), requiere un anillo de enfoque de alto contraste (`focus-visible:ring-white/40 focus-visible:ring-offset-2 focus-visible:ring-offset-navy-dark`), etiquetado `aria-label` explícito y micro-animaciones en el ícono decorativo chevron (`group-hover:-translate-y-0.5 group-focus-visible:-translate-y-0.5`).
**Action:** Acompañar los pies de página con un enlace 'Volver arriba' equipado con `aria-label` descriptivo, anillo de enfoque de alto contraste y micro-animaciones direccionales en hover/focus-visible.
