...
## 2026-03-30 - Navegación accesible de retorno al inicio en pie de página (Footer)
**Learning:** Proveer un enlace "Volver arriba" al final de la página que apunte a `#hero` con micro-animación direccional (`group-hover:-translate-y-0.5 group-focus-visible:-translate-y-0.5`), anillo de enfoque de alto contraste (`focus-visible:ring-2 focus-visible:ring-white/40`) y etiqueta `aria-label="Volver al inicio de la página"` mejora significativamente la usabilidad y navegación por teclado para re-orientar al usuario sin obligarlo a desplazarse manualmente.
**Action:** Incorporar enlaces de retorno al inicio con micro-animaciones direccionales e indicadores WAI-ARIA claros en pies de página sobre fondos oscuros.
