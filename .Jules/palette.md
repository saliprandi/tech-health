...
## 2026-03-30 - Indicador de carga animado SVG y gestión de estado en formularios de contacto
**Learning:** En formularios de contacto que desencadenan redirecciones externas (ej. WhatsApp / webhooks), cambiar solo el texto del botón de envío priva a los usuarios de una señal visual de procesamiento inmediata. Incorporar un ícono vectorial animado (`animate-spin`), alternar dinámicamente la visibilidad del ícono estático y sincronizar `aria-busy="true"` proporciona una respuesta micro-interactiva clara y accesible antes de la navegación.
**Action:** Equipar los botones de envío de formularios con un spinner vectorial conmutado dinámicamente (`animate-spin`) y regiones de anuncio para lectores de pantalla durante eventos de carga.
