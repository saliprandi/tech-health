...
## 2025-02-18 - [UX: Feedback visual progresivo en contadores de caracteres]
**Learning:** El uso de un sistema de semáforo (colores progresivos) en contadores de caracteres proporciona una guía visual intuitiva sobre la capacidad restante. Implementar transiciones de color sutiles (amber al 80%, rojo al 90%) ayuda al usuario a anticipar el límite sin interrumpir el flujo de escritura.
**Action:** Implementar siempre feedback de color multi-etapa en textareas con límites de caracteres para mejorar la comunicación preventiva de restricciones del sistema.
