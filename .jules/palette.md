...
## 2025-02-18 - [UX: Restauración de micro-interacciones en formularios]
**Learning:** La corrupción de scripts en componentes Astro (especialmente redeclaraciones de constantes) puede desactivar silenciosamente micro-interacciones críticas como el feedback de "¡Copiado!" o contadores de caracteres. La limpieza profunda y el uso de TypeScript riguroso (`astro check`) son herramientas de UX esenciales para garantizar que la interfaz responda como el usuario espera.
**Action:** Al reparar componentes rotos, verificar no solo que el build pase, sino que todas las micro-interacciones (hover, focus, avisos de accesibilidad) hayan recuperado su comportamiento determinista.
