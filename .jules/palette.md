...
## 2025-02-17 - [UX: Paridad de foco y accesibilidad en Footer]
**Learning:** Sincronizar los estados de hover con `:focus-visible` en clases globales de botones (como `.btn-primary`) asegura que la experiencia estética sea inclusiva para usuarios de teclado. Además, convertir elementos de texto estáticos (como números de contacto) en enlaces interactivos con estados visuales claros mejora significativamente la utilidad directa del sitio.
**Action:** Siempre implementar paridad de feedback visual en el sistema de diseño global y auditar el footer para asegurar que toda la información de contacto sea accionable y accesible.
